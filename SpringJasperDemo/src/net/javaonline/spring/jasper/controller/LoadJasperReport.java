	...
	try {
		try {
			 ...
			 Class.forName("org.postgresql.Driver");
		 		...
		 		System.out.println("Please include Classpath Where your PostgreSQL Driver is located");
		 		e.printStackTrace(); 
		 	}  

		 conn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/nisum","postgres","nisum");
